...
<template>
    <div class="detail-content">
        ...
        <div class="card">
            ...
            <q-separator style="background:var(--border-color);margin:12px 0;" />
            <div class="item-row">
...
.cancellation-reason { color: var(--color-error); margin-bottom: 4px; }
...
.timeline-dot {
    ...
    &.current { border-color: var(--color-primary); background: rgba(29,107,74,0.2); }
    &.error   { border-color: var(--color-error); background: rgba(192,57,43,0.2); }
}
...
.timeline-label {
    ...
    &.label-error   { color: var(--color-error); font-weight: 600; }
}
