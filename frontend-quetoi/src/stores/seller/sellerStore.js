...
export const useSellerStore = defineStore('sellerStore', {
    ...
    state: () => {
        return {
            ...
            // categories
            homeMenuCategories: [
                {id: 1, label: 'Phở & Bún', icon: '🍜'},
                {id: 2, label: 'Cơm', icon: '🍚'},
                {id: 3, label: 'Bánh mì', icon: '🥖'},
                {id: 4, label: 'Cà phê', icon: '☕'},
                {id: 5, label: 'Tráng miệng', icon: '🍮'},
                {id: 6, label: 'Đông lạnh', icon: '❄️'},
            ],
            selectedHomeMenuCategory: 'Phở & Bún',
