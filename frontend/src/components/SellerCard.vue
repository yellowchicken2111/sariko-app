    ...
    <div class="seller-card" @click="goToSeller">
        ...
        <div class="seller-info">
            <div class="seller-header">
                ...
                <div class="seller-rating">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                        fill="var(--color-accent)" stroke="var(--color-accent)" stroke-width="2" stroke-linecap="round"
            ...
            <div class="seller-previews" v-if="seller.previewImages && seller.previewImages.length > 0">
                <img v-for="(img, idx) in seller.previewImages.slice(0, 3)" :key="idx" :src="img" alt="Food preview"
                    class="preview-img" />
            </div>
        </div>
    </div>
